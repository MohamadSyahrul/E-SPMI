...
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    ...
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
        <button class="button text-white bg-theme-1 shadow-md mr-2">Add Staf</button>
            ...
            <tr>
                ...
                <td class="border-b w-5">
                    <div class="flex sm:justify-center items-center">
                        ...
                        <a class="flex items-center mr-3 text-theme-7" href="{{route('akun-staf.edit',  $item->id)}}"> <i data-feather="check-square"
                            ...
                            <div class="modal" id="delete-modal-preview{{ $item->id }}">
                                <div class="modal__content">
                                    <form action="{{route('akun-staf.destroy', $item->id)}}" method="post" enctype="multipart/form-data">
                                        @method('delete')
                                        @csrf
