...
<div class="col-span-12 lg:col-span-8 xxl:col-span-12">
    ...
    <div class="intro-y box lg:mt-5">
        ...
        <div class="p-5">
            <form action="{{ route('akun-wakil-ketua.update', $item->id)}}" method="POST" enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="grid grid-cols-12 gap-5">
                    ...
                    <div class="col-span-12 xl:col-span-8">
                        ...
                        <div class="text-right mt-5">
                            <a href="{{route('akun-wakil-ketua.index')}}" class="button w-24 border text-gray-700 mr-1">Cancel</a>
