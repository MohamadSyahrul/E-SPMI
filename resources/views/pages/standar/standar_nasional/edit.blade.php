...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 lg:col-span-12">
        ...
        <form action="{{route('standar-nasional.update', $item->id)}}" method="POST">
            @method('put')
            @csrf
            <div class="intro-y box p-5">
                <div>
                    <label>Kode Standar Nasional</label>
                    <input type="text" class="input w-full border mt-2" name="kode_sn" value="{{$item->kode_sn}}" disabled />
                </div>
                <div class="relative mt-2">
                    <label>Nama Standar Nasional</label>
                    <input type="text" class="input w-full border mt-2" name="nama_sn" value="{{ $item->nama_sn }}" placeholder="Nama Standar Nasional">
                </div>
                <div class="relative mt-2">
                    ...
                    <div class="relative w-full mt-1">
                        ...
                        <input type="text" name="tanggal_sn" class="datepicker input pl-12 w-full border">
                    </div>
                </div>
